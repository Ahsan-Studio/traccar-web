...
const TrailersTab = () => {
  ...
  const [trailers] = useState([]); // This would come from Redux store
      ...
      {filteredTrailers.length > 0 ? (
          ...
          <Table size="small">
            ...
            <TableBody>
              {filteredTrailers.map((trailer) => (
                <TableRow key={trailer.id} className={classes.tableRow}>
        ...
        <Box className={classes.emptyState}>
          <Typography variant="body2" color="textSecondary">
            No trailers found. Add trailers to track and manage your trailer fleet.
          </Typography>
        </Box>
      )}
    </Box>
